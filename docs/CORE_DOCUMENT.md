...
are hand-curated. Everything made under the Union base instruments — 2,237 acts CELLAR
...
amending it, and amending more than five acts in all, is an omnibus adaptation — the
comitology and accession regulations that touch a hundred instruments at once — and is left
out. At version 1.0.0 the lists hold 2,268 instruments for the Netherlands and 2,246 for
the EU.
